...
var t = {
  ...
  init: function () {
    ...
    /* Set Control */
    $('div#controller input#setPrev').click(function (e) {
      t.cont.setPrev();
    });
    $('div#controller input#setNext').click(function (e) {
      t.cont.setNext();
    });
    /* Song Control */
    $('div#controller input#songTop').click(function (e) {
      t.cont.songTop();
    });
    $('div#controller input#songPrev').click(function (e) {
      t.cont.scrollPrev();
    });
    $('div#controller input#songNext').click(function (e) {
      t.cont.scrollNext();
    });
    /* Style Control */
    $('div#controller input#clearSong').click(function (e) {
      t.cont.clearSong();
    });
    $('div#controller input#blackScreen').click(function (e) {
      t.cont.blackScreen();
    });
    $('div#controller input#textToggle').click(function (e) {
      t.style.toggleText();
    });
    $('div#controller input#bgToggle').click(function (e) {
